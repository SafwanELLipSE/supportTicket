					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<h6 class="text-center">
								<i class="si si-exclamation text-primary"></i> 7 <span class="text-secondary">Open Ticket</span>
							</h6>
							<hr class="my-2">
							<h6 class="text-center">
								<i class="si si-close text-primary"></i> 5 <span class="text-secondary">Close Ticket</span>
							</h6>
							<hr class="my-2">
							<h6 class="text-center">
