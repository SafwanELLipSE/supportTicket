        	...
        	<tr>
        		...
        		<td class="container" bgcolor="#FFFFFF">
                    ...
                    <h2>{{ $details['title'] }}</h2>
        						...
        						<p class="lead">Good news! {{ $details['body'] }}</p>
                    ...
                    <p> - {{ $details['from']  }}</p>
        						...
        						<p>
                      <a href="#">
                        <img src="https://drive.google.com/uc?export=view&id=1XNq1CygE52Dd1r_f4FdGHOJ5ASxvSxK8" alt="You have got repayments. Re-lend Now" />
                      </a>
                    </p><!-- /hero -->
                   ...
                   <td>
                     <div class="callout" style="text-align:center;margin:0 auto">
                       ...
                       @php
                           $count = 1;
                       @endphp
                       @foreach($details['department'] as $dept)
                         <p>{{$count++}}. {{App\Department::where('id',$dept)->first()->name }}</p>
                       @endforeach
